				...
				<div class="card">
					...
					<div class="card-body px-5">
					 ...
					 <div class="alert alert-danger alert-dismissible fade show"
							role="alert"  id="alert">
							<strong>Invalid Credintials!</strong> Please enter valid fields
							and password must be 8 character above!!
				...
				<label for="validationServer01">First name</label>
				 <input type="text" class="form-control is-valid" id="validationServer01" placeholder="First name" name="username"
								...
								<div class="col-md-6">
									...
									<label for="validationServer01" class="form-label">User Email</label> <input
										name="useremail" type="email" class="form-control is-invalid" id="validationServer01"
										placeholder="Enter email" aria-describedby="emailHelp">
										<p class="invalid-feedback">Enter correct email!</p> 
								...
								<div class="col-md-6">
									...
									<input name="userpassword" type="password" class="form-control is-invalid"
								...
								<div class="col-md-6">
									...
									<label for="phone" class="form-label">User confirm
										...
										class="form-control is-invalid" placeholder="Enter confirm password "
										aria-describedby="passwordHelp">
                                        <p class="invalid-feedback">Enter correct confirm password!</p> 
								</div>
							 	<div class="col-md-12">
